...
#+AUTHOR:    Arnaud Legrand and Jean-Marc Vincent
#+DATE: September 2019
...
Science from October 2018 to January 2019.

* Useful links 
- Here is the [[https://tinyurl.com/MOSIG-SMPE-1819][Pad]] you will use to collaborate.
- Here the [[https://edt.grenoble-inp.fr/2018-2019/exterieur/][lecture schedule on ADE]].
...
* Course Tentative Schedule
  1. 04/10/2018 (AL): Epistemology
  2. 18/01/2018 (AL): Reproducible Research
  3. 25/10/2018 (AL): Litterate Programming (MOOC registration)
  4. 08/11/2018 (AL): Introduction to R and the tidyverse
  5. 15/11/2018 (JM): Visualizing data with ggplot
  6. 22/11/2018 (JM): Introduction to probabilities and statistics,
     Central Limits Theorem and Confidence interval
  7. 29/11/2018 (JM): Statistical tests, correlation/causality
  8. 06/12/2018 (JM): Linear model and linear regression
  9. 13/12/2018 (JM): Linear model and linear regression
  10. 20/12/2018 (AL): Design of Experiments
  11. 10/01/2019 (AL+JM): TBA (defenses?)
  12. 17/01/2019 (AL+JM): TBA (defenses?)
* Hands-on
