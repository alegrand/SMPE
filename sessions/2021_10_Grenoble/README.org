...
- Delect a topic for the lecture on Ethics
** Winter vacations
** 10. 06/01/22 [AL] Incremental DoE: A Bayesian perspective, Reinforcement Learning and Surrogates (Bandit, GP)
    ...
    # - [TODO] App shiny
** 11. 13/01/22 [AL] Scientific integrity (HARKING, p-hacking, data falsification, plagiarism, collusion)
...
** 12. 20/01/22 [CC + JMV] Ethics (AI and humain, climate change, societal challenges)
* Hands-on
