...
- [[file:07_linear_regression/tp-reglineaire.pdf][Multiple linear regression hands-on]] ([[file:07_linear_regression/bats.csv][data]] and [[file:07_linear_regression/HutcEA02.pdf][original article]])
