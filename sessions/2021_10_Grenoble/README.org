...
*** Slides
- [[file:01_epistemology.pdf][slides]]. Notes are in the [[https://codimd.math.cnrs.fr/ukBaKcsHRyKrCFWW2wOK5w#][Pad]].
*** Homeworks (1)
- [ ] Indicate your name on [[https://codimd.math.cnrs.fr/ukBaKcsHRyKrCFWW2wOK5w#][Pad]] you will use to collaborate and fill in all the information you can.
