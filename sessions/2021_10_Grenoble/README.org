...
1. MOOC status report. Feedback on the Challenger exercise.
  - [[https://gitlab.inria.fr/learninglab/mooc-rr/mooc-rr-ressources/-/blob/master/module2/exo5/challenger.pdf][Context description]]
  - [[https://gitlab.inria.fr/learninglab/mooc-rr/mooc-rr-modele/-/blob/master/module2/exo5/exo5_en.ipynb][Jupyter Python Notebook]]
  - [[https://gitlab.inria.fr/learninglab/mooc-rr/mooc-rr-modele/-/blob/master/module2/exo5/exo5_R_en.ipynb][Jupyter R Notebook]]
  - [[https://gitlab.inria.fr/learninglab/mooc-rr/moocrr-reproducibility-study/-/blob/master/src/R/challenger.Rmd][A more "elaborate" version with confidence intervals in R]].
2. Hands on in group on one of the following example:
   ...
   - Empirical evaluation of [[https://en.wikipedia.org/wiki/Fitts%27s_law][Fitts's law]]
     #+BEGIN_QUOTE
...
3. If time allows, short general lecture on measurement or (if needed) on ggplot.
...
*** Homeworks (5)
- [ ] MOOC: Peer evaluated exercise. Deadline is in two weeks.
- [ ] Keep working on, experimenting, and improving what we have done today.
