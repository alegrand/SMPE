...
*** Slides
*** TODO MOOC
- Register to the [[https://learninglab.inria.fr/en/mooc-recherche-reproductible-principes-methodologiques-pour-une-science-transparente/][MOOC on Reproducible Research]] and follow modules 1 + 2 with all exercises (except the last one of module2, on /Challenger/)
** 07/10/21: No lecture
