...
** 3. 21/10/21 [JMV, AL] Data curation with the tidyverse | Data management 1
   ...
   4. Managing data: 
      ...
      - +[[https://angryfrenchman.org/github-s-large-file-storage-is-no-panacea-for-open-source-quite-the-opposite-12c0e16a9a91][Git LFS]]+, [[https://git-annex.branchable.com/special_remotes/][Git annex]], [[http://handbook.datalad.org/en/latest/][datalad]]
*** Homeworks (3)
...
** Fall Vacations
** Armistice
** 5. 18/11/21 [AL|JM + CC] Measurement and tracing
...
** 6. 25/11/21 [AL|JM + CC] Clearly defining the experiment
