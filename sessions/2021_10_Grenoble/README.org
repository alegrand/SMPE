...
** 8. 9/12/21 [EA + AL] Multiple testing and ANOVA (p-hacking) | Seqential DoE (screening, D-opt, LHS)
...
#     - [TODO] App shiny
** Winter vacations
** 10. 06/01/22 A Bayesian perspective, Reinforcement Learning and Surrogates (Bandit, GP)
    # - [TODO] App shiny
