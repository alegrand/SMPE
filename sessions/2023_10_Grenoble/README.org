...
** 2. 05/10/23 [JMV, EA] Visualization and Exploratory Data Analysis | Descriptive statistics; Correlation, causality, and spurious correlation 
** 12/10/23: No lecture
** 3. 19/10/23 [JMV, CC] Data curation  | Data management 1 (Data Management Plans)
** 4. 26/10/23 +JMV+ [JMV, AL] Processing data with the Tidyverse, beautiful viz with ggplot, Tools and tips for data management (Tools)
** Fall Vacations
** 5. 9/11/23 +JMV+ [AL + CC] Measurement and tracing
** 6. 16/11/23  +JMV+  +AL+  [AL] Clearly defining the experiment and having the right tools to analyze it
** 7. 23/11/23  +JMV bof+ [EA] The linear model
** 8. 30/11/23 [EA] Multiple testing and ANOVA (p-hacking)
** 9. 07/12/23 +JMV bof+ [AL] Scientific integrity
** 10. 14/12/23 [AL] A Bayesian perspective on regularization and model selection + Sequential DoE (screening, LHS, D-opt, ...)
** 11. 21/12/23 +JMV bof+[ AL] Incremental DoE: A Bayesian perspective, Reinforcement Learning and Surrogates (Bandit, GP)
** Winter vacations
** 12. 11/01/24 [AL + JMV] Ethics (AI and humain, climate change, societal challenges)
** 25/01/24 Exam
* Hands-on
