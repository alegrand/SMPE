...
*** Homeworks
 - [ ] Start learning R by reading this [[https://htmlpreview.github.io/?https://github.com/alegrand/SMPE/blob/master/sessions/2022_10_Grenoble/R_crash_course.html][R crash course for computer scientists]] ([[file:R_crash_course.Rmd][Rmd sources]]).
...
** 12/10/23: No lecture
** 3. 19/10/23  [ JMV         ] Processing data with the Tidyverse, Data curation, beautiful viz with ggplot
** 4. 26/10/23  [      AL     ]  Data management (Data Tools and tips for Data Management Plans), Measurement and tracing.
** Fall Vacations
** 5. 9/11/23   [      AL     ] Proba, CI
** 6. 16/11/23  [        CC   ] Clearly defining the experiment and having the right tools to analyze it
** 7. 23/11/23  [ +JMV+, AL, CC ] The linear model
** 8. 30/11/23  [ JMV, AL, CC ] Multiple testing and ANOVA (p-hacking)
** 9. 07/12/23  [ +JMV+, AL, CC ] Scientific integrity
** 10. 14/12/23 [ JMV, AL, /CC/ ] A Bayesian perspective on regularization and model selection + Sequential DoE (screening, LHS, D-opt, ...)
