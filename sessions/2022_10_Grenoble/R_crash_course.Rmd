...
```{r}
df = read.csv("https://static.data.gouv.fr/resources/donnees-hospitalieres-relatives-a-lepidemie-de-covid-19/20221005-190201/covid-hosp-txad-fra-2022-10-05-19h02.csv", header = T, sep=";")
str(df)
head(df)
```
