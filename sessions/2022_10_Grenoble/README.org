...
** 13/10/21: No lecture
** 3. 20/10/21 [JMV, AL] Data curation with the tidyverse | Data management 1
** 4. 27/10/21 [JMV, CC] Beautiful Viz with ggplot | Data management 2
** Fall Vacations
...
** 9. 08/12/21 [AL] A Bayesian perspective on regularization and model selection + Sequential DoE (screening, LHS, D-opt, ...)
** 10. 15/01/22 [AL] Incremental DoE: A Bayesian perspective, Reinforcement Learning and Surrogates (Bandit, GP)
** Winter vacations
** 11. 05/01/22 [AL] Scientific integrity
** 12. 12/01/22 [AL + JMV] Ethics (AI and humain, climate change, societal challenges)
* Hands-on
