...
University of Grenoble at the 2nd year Master students in Computer
Science.

* Useful links 
- Here is the [[https://pad.inria.fr/p/ifnk6WrTuhnm3ctS][Pad]] you may use to collaborate.
- Here is a [[https://sondages.inria.fr/index.php/665963/lang-en][poll]]. Please fill it as soon as you have a few minutes
  but do not waste your time doing it during the lecture.
...
1. [[file:../../lectures/lecture_reproducible_research.pdf][Reproducible research]]
2. [[file:../../lectures/lecture_literate_programming.pdf][Literate programming]]
3. [[file:../../lectures/lecture_R_crash_course.pdf][R crash course]]
...
4. [[file:../../lectures/lecture_descriptive_univariate.pdf][Descriptive statistics of univariate data]]
5. [[file:../../lectures/lecture_data_presentation.pdf][Data presentation]]
6. [[file:../../lectures/lecture_correlation_causation.pdf][Correlation and causation]]
7. [[file:../../lectures/3_introduction_to_statistics.pdf][Introduction to probabilities/statistics]] ([[file:../../lectures/lecture_central_limit_theorem.pdf][Proof of the Central
   limit theorem]])
8. [[file:../../lectures/4_linear_model.pdf][Linear regression]]
9. [[file:../../lectures/5_design_of_experiments.pdf][Design of Experiments]]
10. [[file:../../lectures/lecture_epistemology.pdf][Epistomology]]
