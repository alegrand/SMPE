...
#+AUTHOR:    Cyril Labbé and Arnaud Legrand
#+DATE: October 2026
#+STARTUP: overview indent
#+PROPERTY: header-args :eval never-export

*Teachers*: Cyril Labbé and Arnaud Legrand

[[file:../2024_10_Grenoble/cyril.jpg][file:../2024_10_Grenoble/cyril.jpg]][[file:../2021_10_Grenoble/arnaud.png][file:../2021_10_Grenoble/arnaud.png]]
...
Science (MOSIG) from October 2026 to January 2027]], on Thursday from
11h15 to 12h45, usually in room [[https://maps.app.goo.gl/RsXTPPfGGEccqGAR6][C0007]].

* Useful links 
- Here is the [[https://codimd.math.cnrs.fr/L-taV29nRnaiskzgygrdHA][Pad]] you will use to collaborate.
- Here is the [[https://edt.grenoble-inp.fr/2026-2027/exterieur][lecture schedule on ADE]] (look for =mosig2=). A table summary is [[https://edt.grenoble-inp.fr/2026-2027/exterieur/jsp/custom/modules/plannings/eventInfo.jsp?week=-1&day=-1&slot=0&eventId=31978&activityId=-1&resourceId=-1&sessionId=-1&repetition=-1&order=slot&availableZone=-1][here]] and the lecture takes mostly place in room [[https://maps.app.goo.gl/RsXTPPfGGEccqGAR6][C0007]] (lecture 1 is in C009, lecture 2 in H206, and lecture 3 in H105).
- Here is the [[https://framateam.org/signup_user_complete/?id=jotsbkxj9tff7eti54qbgnc4hw&md=link&sbr=su][Invitation link]] for the [[(https://framateam.org/smpe-2026-2027/channels/town-square][Mattermost]] we will use to exchange information.
...
You may want to look at the [[file:../2025_10_Grenoble/README.org][previous edition]] to see the kind of
material we use but we will adapt to the audience on the fly anyway.
...
#+RESULTS:
1. 24/09/26  [ AL        ] Presentation of the lecture | Processing data with the Tidyverse, beautiful viz with ggplot
2. 01/10/26  [ AL        ] Clearly defining the experiment and having the right tools to analyze it
3. 08/10/26  [ AL        ] Visualization and Exploratory Data Analysis
4. 22/10/26  [ AL        ] Probabilities, CI, estimation
5. 05/11/26  [ AL        ] Estimation, correlation
6. 12/11/26  [ AL        ] Correlation and the linear model
7. 19/11/26  [ AL        ] The linear model, Multiple testing and ANOVA (p-hacking), and a bit of DoE
8. 03/12/26  [ CL        ] The publication system 1
9. 10/12/26  [ AL        ] DoE
10. 17/12/26 [ CL        ] The publication system 2
11. 07/01/27 [ AL        ] Scientific Integrity
12. 14/01/27 [ AL        ] Ethics (AI and humain, climate change, societal challenges)

** 1. 24/09/26  [ AL        ] Presentation of the lecture | Processing data with the R
*** Slides
- [[file:../../lectures/lecture_SMPE_overview.pdf][Overview of the lecture]]
- [[https://htmlpreview.github.io/?https://github.com/alegrand/SMPE/blob/master/sessions/2022_10_Grenoble/R_crash_course.html][R crash course for computer scientists]] (without the ~dplyr~ / ~ggplot~ part).
*** Homeworks
- [ ] Indicate your name on the [[https://codimd.math.cnrs.fr/L-taV29nRnaiskzgygrdHA][Pad]]. You will use to collaborate and fill in all the information you can.
- [ ] Register on the [[https://framateam.org/smpe-2026-2027/channels/town-square][Mattermost]] through this [[https://framateam.org/signup_user_complete/?id=jotsbkxj9tff7eti54qbgnc4hw&md=link&sbr=su][invitation link]]. This is the preferred communication mode.
- [ ] Fill this [[https://sondages.inria.fr/index.php/384449?lang=en][survey]] (it will expire on September 29th at 1AM)
...
- [ ] Report the URL of your git project, your mattermost ID on the [[https://codimd.math.cnrs.fr/L-taV29nRnaiskzgygrdHA][Pad]].
...
- [ ] Start following modules 1 + 2 of the MOOC and complete as much exercises as possible (except the last one of module2, on /Challenger/; watching interviews is optional)
...
- [ ] Start learning R by reading this [[https://htmlpreview.github.io/?https://github.com/alegrand/SMPE/blob/master/sessions/2022_10_Grenoble/R_crash_course.html][R crash course for computer scientists]] ([[file:../2022_10_Grenoble/R_crash_course.Rmd][Rmd sources]]). If you want more resources, look below in the "Learning R" section or ask me.
** 2. 01/10/26  [ AL        ] Visualization and Exploratory Data Analysis with the tidyverse and ggplot
...
*** Homeworks
 ...
 - [ ] Criticize every figure of Jean-Marc's slides by:
   ...
   2. Proposing a better representation (hand-drawing is fine but feel free to give a try to =ggplot2=) that passes the checklist.
...
** 2. 03/10/26  [ AL        ] Clearly defining the experiment and having the right tools to analyze it
# *** Slides and resources
...
** 6. 12/11/26  [ AL        ] Correlation and the linear model
# *** Slides and resources
# - Feedback on Challenger. See
#   - https://utstat.toronto.edu/reid/sta2101f/shuttle.pdf
#   - https://gitlab.inria.fr/learninglab/mooc-rr/moocrr-reproducibility-study/-/blob/master/challenger.pdf
#   - file:challenger/exo5_en2.Rmd
#   - https://gitlab.inria.fr/learninglab/mooc-rr/moocrr-reproducibility-study.
#   - file:challenger/Tufte_Visual_Explanations_Challenger.pdf
# - Quick reminder regarding transparency through the [[file:../../lectures/lecture_correlation_causation.pdf][correlation and causality]] issue.
# - Going beyond independant evaluations with the [[file:../../lectures/4_linear_model.pdf][linear model]]
# *** Homeworks
# - Compute independant CIs for the data in https://github.com/alegrand/M2R-ParallelQuicksort if you haven't done so yet
# - Fit a linear model for the data in https://github.com/alegrand/M2R-ParallelQuicksort
# - Advance the MOOC Peer evaluated exercise.  
** 7. 19/11/26  [ *JMV*       ] The linear model, Multiple testing and ANOVA (p-hacking), and a bit of DoE
# *** Slides and resources
...
** 8. 03/12/26  [ *CL*        ] The publication system 1
# *** Slides and resources
# - [[file:CL_SMPE_P1.pdf][Scientific Publications and Scientific Integrity]]
...
# *** Homeworks
# - For the 18/12, read the papers available [[https://cloud.univ-grenoble-alpes.fr/s/3Ro6LpMbP6fckFH][here]]. Spend no more than
#   10-15 minutes per article and try to answer the following questions:
#   - Is this paper worth being read?
#   - Is it a famous paper?
#   - Any other point about it you would like to make...
...
# - Try to complete the peer-evaluation of the MOOC
** 10. 17/12/26 [ AL        ] Scientific Integrity
# *** Slides and resources
# - [[file:../../lectures/lecture_scientific_integrity.pdf][Introduction to scientific integrity, deontology and ethics]]
# # - [[file:11_chatbot.pdf][Slides on Lovots and chatbots]]
# *** Homeworks
# - Complete the Peer Evaluated exercise from the MOOC.
...
** Winter vacations
** 11. 07/01/27 [ *CL*        ] The publication system 2
# *** Slides and resources
# - [[file:CL_SMPE_P2.pdf][Scientific Publications and Scientific Integrity (2)]]
# *** Homeworks
