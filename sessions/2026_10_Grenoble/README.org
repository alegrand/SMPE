...
Science (MOSIG) from October 2026 to January 2027]], on Tuesday from
14h00 to 15h30 in in room [[https://maps.app.goo.gl/RsXTPPfGGEccqGAR6][C0004]].

* Useful links 
- Here is the [[https://codimd.math.cnrs.fr/L-taV29nRnaiskzgygrdHA][Pad]] you will use to collaborate.
- Here is the [[https://edt.grenoble-inp.fr/2026-2027/exterieur][lecture schedule on ADE]] (look for =mosig2=). A table summary is [[https://edt.grenoble-inp.fr/2026-2027/exterieur/jsp/custom/modules/plannings/eventInfo.jsp?week=-1&day=-1&slot=0&eventId=31978&activityId=-1&resourceId=-1&sessionId=-1&repetition=-1&order=slot&availableZone=-1][here]] and the lecture takes place in room [[https://maps.app.goo.gl/RsXTPPfGGEccqGAR6][C0004]].
...
** 1. 22/09/26  [ AL        ] Presentation of the lecture | Processing data with the Tidyverse, beautiful viz with ggplot
*** Slides
...
** 2. 29/09/26  [ AL        ] Clearly defining the experiment and having the right tools to analyze it
...
** 3. 06/10/26  [ AL        ] Visualization and Exploratory Data Analysis
# *** Slides and resources
...
** 4. 13/10/26  [ AL        ] Probabilities, CI, estimation
# *** Feedback
...
** 5. 20/10/26  [ AL        ] Estimation, correlation
# *** Feedback
# - See the pad
# *** Slides and resources
...
** Fall Vacations
** 6. 03/11/26  [ AL        ] Correlation and the linear model
# *** Slides and resources
...
** 7. 10/11/26  [ AL        ] The linear model, Multiple testing and ANOVA (p-hacking), and a bit of DoE
# *** Slides and resources
...
** 8. 17/11/26  [ CL        ] The publication system 1
# *** Slides and resources
...
** Winter vacations
** 12. 05/01/27 [ AL        ] Ethics (AI and humain, climate change, societal challenges)
** 26/01/27: Exam ?
