...
- Quick reminder regarding transparency trhough the [[file:../../lectures/lecture_correlation_causation.pdf][correlation and causality]] issue.
...
** Winter vacations
** 11. 08/01/26 [ AL|JMV    ] Scientific Integrity
*** Slides and resources
- [[file:../../lectures/lecture_scientific_integrity.pdf][Introduction to scientific integrity, deontology and ethics]]
