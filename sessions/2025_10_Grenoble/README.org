...
** 4. 16/10/25  [           ] Follow-up experiments | Data management tips (Data Tools)
*** Feedback
- Challenger.
...
** 5. 23/10/25  [           ] Probabilities, CI | Correlation, Causality
*** Slides and resources
...
- MOOC Peer evaluated exercise.  
** 7. 20/11/25  [           ] The linear model, Multiple testing and ANOVA (p-hacking), and a bit of DoE
*** Slides and resources
...
- Try to complete the peer-evaluation of the MOOC
** 9. 04/12/25  [ CL        ] Scientific Integrity 1
*** Slides and resources
...
** 10. 11/12/25 [ CL        ] Scientific integrity 2
*** Slides and resources
*** Homeworks
- MOOC Peer evaluated exercise.
** 11. 18/12/25 [           ] Ethics 101 
*** Slides and resources
...
** Winter vacations
** 12. 08/01/26 [          ] Ethics (AI and humain, climate change, societal challenges)
** 26/01/25: Exam ?
