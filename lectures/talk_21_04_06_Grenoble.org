...
#+DATE:  \vspace{1cm}\JDEVlogo \href{https://reproduct2021.sciencesconf.org/}{Séminaire RR, Grenoble}, April 2021\hfill \mylogo\vspace{-1.3cm}
#+LANGUAGE: en
...
_*Methodological or technical causes*_ 
...
\begin{overlayarea}{\linewidth}{0cm}
  ...
  \begin{center}
    ...
    \only<.>{\href{https://juyterhub.u-ga.fr/}{https://juyterhub.u-ga.fr/}}
  \end{center}
\end{overlayarea}
#+END_EXPORT
