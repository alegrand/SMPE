...
7. \fbox{The Linear model}\smallskip
   - \scriptsize \textbf{No lecture}\smallskip
8. \fbox{The academic system}
9. \fbox{Design of Experiments}
10. \fbox{The academic system}
    - \scriptsize \textbf{Winter vacations}\smallskip
11. \fbox{Ethics 101}\smallskip
...
The *MOOC* [[https://www.fun-mooc.fr/fr/cours/reproducible-research-ii-practices-and-tools-for-managing-comput/][RR2: Practices and tools for managing computations and data]], 2024
#+latex: }
