...
- Whenever I upgrade my computer, things break so I try to stay away
  from this  $\frowny$
- Whenever trying the code of my colleague, I had to install  =libFoo-1.5= but
...
- But hey! Here is my code, feel free to play with it! I'm doing open
  ...
  \textbf{Are you really aware of your dependencies ?}
...
- Developed in 2005 by Linus Torvalds for the kernel development
  #+latex: \hfill\begin{overlayarea}{3mm}{0mm}\vspace{-1.7cm}\includegraphics[width=1.4cm]{./images/linus.jpg}\end{overlayarea}\hspace{.2cm}\null
