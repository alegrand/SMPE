...
#+DATE: UFRGS, October 2019\hfill \mylogo
#+LANGUAGE: en
...
- $\blacktriangleright$ Shared testbeds and Experimental control ::
     Grid'5000/SILECS, ...
* Future
...
1. \textbf{Train yourself and your students on RR}, statistics, experiments
   - Beware of checklists and norms
   - Understand what's at stake
2. \textbf{Make publication practices evolve} 
3. \bgroup\bf Prepare the Future: Toward *literate experimentation*?\egroup
   - Reuse, reuse, reuse
