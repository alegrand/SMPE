...
#+DATE: February 28, 2017 -- ENS Rennes
...
- 1997 :: ENS Lyon in Computer Science
- 2000-2003 :: Ph.D. Computer Science, École Normale Supérieure de
     Lyon.  /Heterogeneous parallel algorithms and scheduling : static
     and dynamic approaches/ (O. Beaumont and Y. Robert).
- 2003-2004: :: Post-Doct. École Normale Supérieure de Lyon
- 2004-2005: :: Post-Doct. Univ. California San Diego
- Oct. 2004-\dots: :: Tenured CNRS Researcher at Laboratoire
     d'Informatique de Grenoble (Inria MESCAL team). 

_Main research topics_:
  1. \textbf{Scheduling for Distributed Platforms}: parallel algorithms,
     scheduling, combinatorial optimization, game theory, ...
  2. \textbf{Simulation and Performance Evaluation}: modeling,
     simulation and validation, probabilities and statistics, data
     visualisation, ...
- Jan. 2015 :: Leader of the Inria POLARIS team
...
- Large distributed infrastructures ::  
  ...
  #+BEGIN_LaTeX
    \hbox{\hspace{-.7cm}%
      \includegraphics[height=2.15cm]{images/plat_titan.jpg}
      \includegraphics[height=2.15cm]{images/plat_wireless.jpg}
      \includegraphics[height=2.15cm]{images/plat_smartgrid.jpg}
      \includegraphics[height=2.15cm]{images/plat_bikesharing.jpg}%
    }
  #+END_LaTeX
- Common questions :: scalability, resilience, adaptability, capacity
  planning, energy consumption, \dots\vspace{-.4em}
- Common characteristics :: ever growing size, distributed,
  heterogeneous, user-centric $\leadsto$ _stochastic nature_
# - Many *invalid hypothesis*, which requires *involved tools and
#   techniques* on which other teams from the D&HPC theme cannot
#   afford to invest
 \vspace{-2em}
# This requires involved tools and new techniques\pause
  + \small \structure{Experiment design}: \footnotesize observation tools,
       experimental methodology (design, control)\vspace{-.4em}
  + \small \structure{Modeling and Simulation}: \footnotesize discrete event
       simulation, emulation, Markov chains, perfect sampling, mean
       field limits, Monte Carlo methods, ...\vspace{-.4em}
  + \small \structure{Analysis}: \footnotesize workload characterization,
    visualization and anal. of parallel applications\vspace{-.4em}
  + \small \structure{Optimization}: \footnotesize stochastic approximations, game
    theory, mean field games, primal dual optimization, learning,
    information theory\vspace{-.4em}
*** 
\maketitle
* Science crisis ?
...
#+LaTeX:   \end{column}\begin{column}{.17\linewidth}
#+ATTR_LaTeX: :height 1.7cm
