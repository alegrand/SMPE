# -*- coding: utf-8 -*-
# -*- mode: org -*-
#+Title:  \scalebox{.95}{Reproducibility Crisis, Open Science, and Software Factories}
...
#+LATEX_HEADER: \def\logoInstitutions{\includegraphics[height=.7cm]{./images/Logo-UGA2020.pdf}\quad\includegraphics[height=.7cm]{./images/Logo-CNRS.pdf}\quad\includegraphics[height=.7cm]{./images/Logo-Inria.pdf}\includegraphics[height=.7cm]{./images/logo-lig-new-orange.jpg}\vspace{-.7cm}}
...
:END:
  ...
  Sabrina Granger, Loïc Desquilbet, Sabrina Granger, Boris Hejblum,
...
#+BEGIN_CENTER
Slides (with hyperlinks) available at:
[[https://github.com/alegrand/SMPE/raw/master/lectures/talk_20_07_07_JDEV.pdf][https://github.com/alegrand/SMPE/raw/master/lectures/talk_20_07_07_JDEV.pdf]]
#+END_CENTER
...
1. _Universality_: Science aims for *objective findings*, *accessible to
   anyone*
   #+BEGIN_CENTER
   *Reproducibility* acts as a *Universality control*\bigskip
   #+END_CENTER
...
:Beamer_opt: t
:END:
#+LaTeX: \hfill\href{https://theconversation.com/how-computers-broke-science-and-what-we-can-do-to-fix-it-49938}{\includegraphics[width=\linewidth,valign=t]{images/computer_broke_science.jpg}}
...
- The generalized and intensive use of [[https://genomebiology.biomedcentral.com/articles/10.1186/s13059-016-1044-7][*spreadsheets*]]
...
Bad computer/statistic/publication practices and "broke science"
$\winkey$
...
:BEAMER_col: .7
:END:
Raising *awareness on reproducibility issues*, covering the *"basics" of
Reproducible Research*?
- Note taking, version control, computational documents
Covered in the [[https://learninglab.inria.fr/en/mooc-recherche-reproductible-principes-methodologiques-pour-une-science-transparente/][Reproducible Research MOOC]]
*** MOOC pic                                                        :BMCOL:
:PROPERTIES:
:BEAMER_col: .28
:END:
#+LaTeX: \includegraphics[width=\linewidth,valign=t]{images/mooc_rr.png}
*** Technical questions                                   :B_ignoreheading:
:PROPERTIES:
:BEAMER_env: ignoreheading
:END:
\pause\textbf{Friday at the JDEV, we'll cover technical questions}
- Software Environment Control (Docker, *Guix* / Nix, ...)
- *Continuous Integration* / deployment and DevOps
- *Pipelines and Workflows*
- Perennial software Archives and References (*Software Heritage*)
- *Numerical Reproducibility* and *Parallel Codes*
- Dealing with all this at once, in an *industrial* way, whereas
  researchers are *crafts[wo]men*
