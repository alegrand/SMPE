...
** Public Evidence for a Lack of Reproducibility                  :noexport:
\small
...
\vspace{5cm}
** How to explain it to my compiler?                              :noexport:
...
** Software/Hardware dependencies                                 :noexport:
...
1. \textbf{Train yourself and your students}: RR, statistics, experiments
   ...
   #+latex: \end{column}\end{columns}\vspace{-.5em}\pause
   \small\hspace{-.8cm} *MOOC "Advanced RR"* planned for Mar. 2024
