...
\small
- 1997 :: ENS Lyon
- 2000-2003: :: Ph.D. @ LIP, /Heterogeneous parallel algorithms
  and scheduling: static and dynamic approaches/
  (O. \textsc{Beaumont} and Y. \textsc{Robert})
- 2004-2005 :: "Post-doc" LIP and UC San Diego (H. \textsc{Casanova})
- 2005 :: CR CNRS @ LIG (MESCAL team), Grenoble
- 2015 :: HDR /Scheduling for Large Scale Distributed/ /Computing
  Systems: Approaches and Performance Evaluation Issues./
- 2016 :: *POLARIS* research team
- 2018 :: DR CNRS
- 2021-2026 :: Section 6 CoNRS
*** Research Themes
- Scientific computing :: cluster, grid, volunteer computing, clouds, \rlap{supercomputers}\vspace{-.5em}
- Performance optimization :: scheduling, combinatorial/continuous \rlap{optimization,}\vspace{-.3em}\newline
  game theory, reinforcement learning\vspace{-.5em}
- Performance evaluation :: predictive simulation, trace analysis and \rlap{visualization,} \vspace{-.3em}\newline statistical modeling\vspace{-.5em}
- Research reproducibility and Open science ::
** What is Science about?                                         :noexport:
#+BEGIN_CENTER
*Question*: \uline{In less than 5 lines give a definition of "Science"}
#+END_CENTER
\pause\small
...
* Controling the whole software/compiling stack is not sufficient
