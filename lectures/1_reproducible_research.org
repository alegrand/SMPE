...
* List                                                             :noexport:
** TODO Update from [[file:2015_04_24_journee_trace.org]]
** TODO No lecture on ggplot but only on R/knitr
** TODO Fraud
http://science21.blogs.courrierinternational.com/archive/2015/07/04/fraude-scientifique-l-affaire-de-dong-pyou-han-i-51017.html
...
#+END_CENTER
*** A few Experiment Management Tools                            :noexport:
...
*** A few Environment Management Tools                           :noexport:
...
- I recommend to use basic *plain-text* format and to *structure it
  hierarchically*
  #+BEGIN_CENTER 
  Here is a *[[https://gforge.inria.fr/scm/browser.php?group_id%3D6337][link]]* to one of my PhD student's journal \\
