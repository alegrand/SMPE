...
#+begin_src R :results output graphics :file pdf_babel/var_1.pdf :exports results :width 6 :height 3 :session
N = 1000;
...
- *Variance*: $V = \frac{1}{N} \sum_{i=1}^N (x_i-A)^2$
  - squared to have only positive values and to give more importance
    to large deviations
