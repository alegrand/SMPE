# -*- coding: utf-8 -*-
# -*- mode: org -*-
#+Title:  Laboratory Notebooks and Reproducible Research
#+Author: Arnaud Legrand\medskip\newline\logoInstitutions
#+DATE:  \vspace{1cm}\JDEVlogo February 2021, Journées DKM, Irisa\hfill \mylogo\vspace{-1.3cm}
#+LANGUAGE: en
...
#+LATEX_HEADER: \newcommand{\mylogo}[1][2.5cm]{\includegraphics[height=#1]{./images/in_science_we_trust.jpg}}
...
:END:
#+begin_export latex
\hspace{-.08\linewidth}\begin{overlayarea}{1\linewidth}{0cm}
  \vspace{-7cm}%
  \begin{block}<3-4>{\href{https://www.elabftw.net/}{\alert{Example:} eLabFTW}}
    \includegraphics<3>[width=1.2\linewidth]{images/notebooks/eLabFTW-screen-1.jpg}%
    \includegraphics<4>[width=1.2\linewidth]{images/notebooks/eLabFTW-screen-2.jpg}
  \end{block}
\end{overlayarea}
#+end_export
...
\small\hspace{-5mm} \textbf{Different Reproducibility Concerns in Modern Science}\vspace{-3mm}
...
\end{overlayarea}
#+END_EXPORT
* Reproductibility Crisis                                          :noexport:
...
** How computers broke science                                    :noexport:
...
** Changing Research Practices                                    :noexport:
...
** Changing Research Practices (Rigor and Transparency)
*** *Manifesto*: /I solemnly pledge/ ([[https://hal.inria.fr/hal-01367344/document][WSSSPE]], [[http://lorenabarba.com/gallery/reproducibility-pi-manifesto/][Lorena Barba]], [[https://www.go-fair.org/fair-principles/][FAIR]])   :B_block:
:PROPERTIES:
:BEAMER_env: block
:END:
\footnotesize\vspace{-.4em}
  1. I will teach my graduate students about _reproducibility_ \vspace{-1mm}
  2. All our research code (and writing) is under _version control_ \vspace{-1mm}
  3. We will always carry out _verification_ and _validation_ \vspace{-1mm}
  4. We will _share_ data, plotting script & figure _under CC-BY_ \vspace{-1mm}
  5. We will upload the _preprint_ to arXiv at the time of submission of
     a paper \vspace{-1mm}
  6. We will _release code_ at the time of submission of a paper \vspace{-1mm}
  7. We will add a _"Reproducibility" declaration_ at the end of each
     paper \vspace{-1mm}
  8. I will keep an _up-to-date web presence_ \vspace{-1mm}
\normalsize\pause
***                                                       :B_ignoreheading:
:PROPERTIES:
:BEAMER_env: ignoreheading
...
\vspace{-1cm}\hfill\mylogo[2cm]\vspace{-1cm}
\end{overlayarea}
#+end_export
*** *Changing Research Practices*                                 :B_block:
:PROPERTIES:
:BEAMER_env: block
:END:
\small
1. \textbf{Train yourself and your students}: RR, statistics, experiments
   - \footnotesize  _Soft. Engineering_, _Statistics_, and Reproducible Research in the *curricula*
   - \footnotesize Beware of checklists and norms. Understand what's at stake!
...
** Some +Advertising+ Resources $\textcolor{black}\winkey$
*** Book pic                                                        :BMCOL:
:PROPERTIES:
:BEAMER_col: .17
:BEAMER_OPT: t
...
- *3rd Edition*: March 2020 -- March _2022_
- *MOOC RR "Advanced"* (2021?)
*** MOOC pic                                                        :BMCOL:
:PROPERTIES:
:BEAMER_col: .35
:BEAMER_OPT: t
