...
- Impact of the compiler
  - \scriptsize Not even mentioning the lack of determinism\newline
    stemming from MPI collective communication optimization \newline and
...
\vspace{-1em}\begin{center}
  \begin{tabular}{m{.5\linewidth}m{.5\linewidth}}
    ...
    \emph{(versions differ + permeability)}\newline
...
2. Controling your *dependencies* (reproducible recipe)
...
- 2024 :: A badge requires the reproduction of the /main result/
  ...
  - *Work budget:* no more than 8 hours!
    - double the committee, at least 2 evaluators par article and about 2 articles per evaluators
  #+latex: }\pause
- Conclusion ::  
