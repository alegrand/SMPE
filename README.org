...
#+begin_center
*If you are a MOSIG student, the webpage for your session is [[file:sessions/2025_10_Grenoble/README.org][here]]*.
#+end_center
...
for i in `ls lectures/talk*.pdf | sort -r | head -n 10`;  do
...
#+RESULTS:
- [[file:lectures/talk_26_01_22_INSEE_Paris.pdf][INSEE_Paris (22/01/2026)]]
- [[file:lectures/talk_25_12_09_Inria_Grenoble.pdf][Inria_Grenoble (09/12/2025)]]
- [[file:lectures/talk_25_02_27_ROADEF_Paris.pdf][ROADEF_Paris (27/02/2025)]]
